...
1. Run `stretch_robot_home.py` to home Stretch.
...
5. In a seperate terminal, run the command `python3 drinky_buddies/arucoApproach.py`. Ensure that Stretch can see the ArUco marker when you do so!
