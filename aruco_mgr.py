...
class LocateArUcoTag(hm.HelloNode):
    """
    A class that actuates the RealSense camera to find the target_frame
    ...
    def find_tag(self, tag_name='target_frame'):
        """
        ...
        :returns transform: The target_frame's TransformStamped message.
        """
        ...
        for i in range(self.tilt_num_steps):
            for j in range(self.pan_num_steps):
                ...
                try:
                    ...
                    # TODO: Make it run command once it find target_frame!
                    return transform
    ...
    def main(self):
        ...
        self.get_logger().info('Searching for target_frame ArUco tag')

        # Search for the ArUco marker for the target_frame station
        pose = self.find_tag("target_frame")
